...
Shader "Toon Pro"
{
	Properties
	{
		...
		_ShadowColorMy("Shadow Color My", Color) = (0,0,0,0)
...
inline float4 ASE_ComputeGrabScreenPos( float4 pos )
{
	...
	return o;
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float3 lerpResult1931 = lerp( _ShadowColorMy.rgb , ase_lightColor.rgb , saturate( smoothstepResult444 ));
			...
			float3 lerpResult1626 = lerp( _ShadowColorMy.rgb , lerpResult1931 , temp_output_1875_0);
			float2 appendResult356 = (float2(( _LightRampOffset + saturate( temp_output_1188_0 ) ) , 0.0));
			float2 temp_cast_9 = (0.02).xx;
			float2 temp_cast_10 = (0.98).xx;
			float2 clampResult358 = clamp( appendResult356 , temp_cast_9 , temp_cast_10 );
			float4 lerpResult1617 = lerp( tex2D( _LightRampTexture, float2( 0.02,0 ) ) , ( tex2D( _LightRampTexture, clampResult358 ) * float4( ase_lightColor.rgb , 0.0 ) ) , temp_output_1875_0);
			...
			float3 lerpResult1629 = lerp( _ShadowColorMy.rgb , ase_lightColor.rgb , localPosterize1331);
			float3 lerpResult1628 = lerp( _ShadowColorMy.rgb , lerpResult1629 , temp_output_1875_0);
			#if defined( _USELIGHTRAMP_STEP )
				float4 staticSwitch372 = float4( lerpResult1626 , 0.0 );
			#elif defined( _USELIGHTRAMP_DIFFUSERAMP )
				float4 staticSwitch372 = lerpResult1617;
			#elif defined( _USELIGHTRAMP_POSTERIZE )
				float4 staticSwitch372 = float4( lerpResult1628 , 0.0 );
			#else
				float4 staticSwitch372 = float4( lerpResult1626 , 0.0 );
			#endif
			...
			float3 temp_cast_16 = (( BNLightWarpVector250 + ( ( 1.0 - BNLightWarpVector250 ) * BNNDotL233 ) )).xxx;
			float3 temp_cast_17 = (BNNDotL233).xxx;
			float3 CompleteDiffuseLight965 = ( _DiffuseWarpAffectHalftone == 1.0 ? ( temp_output_260_0 * ShadowAtten1415 ) : ( max( temp_cast_17 , float3(0,0,0) ) * BNAttenuationColor244 * ShadowAtten1415 ) );
			float3 break3_g201 = CompleteDiffuseLight965;
			float smoothstepResult525 = smoothstep( _HalftoneEdgeOffset , ( _HalftoneEdgeOffset + _HalftoneSmoothness ) , max( max( break3_g201.x , break3_g201.y ) , break3_g201.z ));
			float4 unityObjectToClipPos2_g200 = UnityObjectToClipPos( ase_vertex3Pos );
			float4 computeScreenPos3_g200 = ComputeScreenPos( unityObjectToClipPos2_g200 );
			float temp_output_29_0_g200 = ( _OverlayUVTilling / 4.0 );
			float4 unityObjectToClipPos13_g200 = UnityObjectToClipPos( float3(0,0,0) );
			float4 computeScreenPos17_g200 = ComputeScreenPos( unityObjectToClipPos13_g200 );
			float4 transform20_g200 = mul(unity_ObjectToWorld,float4( 0,0,0,1 ));
			float4 break22_g200 = ( ( ( ( computeScreenPos3_g200 / (computeScreenPos3_g200).w ) * temp_output_29_0_g200 ) - ( temp_output_29_0_g200 * ( computeScreenPos17_g200 / (computeScreenPos17_g200).w ) ) ) * distance( ( float4( _WorldSpaceCameraPos , 0.0 ) - transform20_g200 ) , float4( 0,0,0,0 ) ) );
			float4 break26_g200 = _ScreenParams;
			float4 appendResult24_g200 = (float4(( break22_g200.x * ( break26_g200.x / break26_g200.y ) ) , break22_g200.y , break22_g200.z , break22_g200.w));
			...
			float2 uv_TexCoord478 = i.uv_texcoord * temp_cast_22 + temp_output_1288_0;
			float cos1047 = cos( radians( _OverlayRotation ) );
			float sin1047 = sin( radians( _OverlayRotation ) );
			float2 rotator1047 = mul( ( _UseScreenUvs == 1.0 ? ( ( _UseAdaptiveScreenUvs == 1.0 ? appendResult24_g200 : ( float4( appendResult1849, 0.0 , 0.0 ) * ase_grabScreenPosNorm ) ) + float4( appendResult1803, 0.0 , 0.0 ) + float4( temp_output_1288_0, 0.0 , 0.0 ) ) : float4( uv_TexCoord478, 0.0 , 0.0 ) ).xy - float2( 0.5,0.5 ) , float2x2( cos1047 , -sin1047 , sin1047 , cos1047 )) + float2( 0.5,0.5 );
			...
			float4 Halftone1022 = ( lerpResult1774 + IndirectDiffuseLight1269 );
				...
				float4 staticSwitch1231 = BNFinalDiffuse239;
			#endif
			float3 normalizeResult222 = normalize( ( _WorldSpaceLightPos0.xyz * ( 1.0 - _WorldSpaceLightPos0.w ) ) );
			...
			float2 uv_TexCoord1123 = i.uv_texcoord * temp_cast_30;
			...
			float3 break3_g202 = ( RimLight460 + BNDiffuse391 + Emission680 + BNspecularFinalColor243 ).rgb;
			float temp_output_1064_0 = (( _Darken * -2.0 ) + (max( max( break3_g202.x , break3_g202.y ) , break3_g202.z ) - 0.0) * (( ( _Lighten * 2.0 ) + 1.0 ) - ( _Darken * -2.0 )) / (1.0 - 0.0));
...
/*ASEBEGIN
Version=19501
Node;AmplifyShaderEditor.CommentaryNode;277;-8712.34,-525.5221;Inherit;False;6331.035;6906.721;;14;217;1122;386;901;390;213;385;215;216;219;1840;1844;381;1932;BlinnPhong;0.2631274,0.6002151,0.6886792,1;0;0
...
Node;AmplifyShaderEditor.SamplerNode;1541;4409.913,2321.428;Inherit;True;Property;_BumpMap;Normal Map;28;1;[Normal];Create;False;0;0;0;True;0;False;-1;None;None;True;0;False;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.SamplerNode;375;-5906.418,466.2107;Inherit;True;Property;_DiffuseWarpNoise;Diffuse Warp Noise;16;2;[NoScaleOffset];[SingleLineTexture];Create;False;0;0;0;True;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.GetLocalVarNode;1542;-7632,-416;Inherit;False;1538;BNCurrentNormal;1;0;OBJECT;;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.CommentaryNode;217;-6702.856,-372.6217;Inherit;False;1449.758;385.0905;;9;1913;265;238;237;236;222;1912;226;1914;Half Dir;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.WorldSpaceLightPos;226;-6672,-320;Inherit;False;0;3;FLOAT4;0;FLOAT3;1;FLOAT;2
...
Node;AmplifyShaderEditor.OneMinusNode;1912;-6368,-224;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;240;-7808,1904;Inherit;False;244;BNAttenuationColor;1;0;OBJECT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SamplerNode;636;4370.918,1121.404;Inherit;True;Property;_SpecGlossMap;Specular Map;35;2;[NoScaleOffset];[SingleLineTexture];Create;False;0;0;0;True;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;1913;-6176,-256;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.NormalizeNode;222;-5984,-320;Inherit;False;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.ViewDirInputsCoordNode;236;-5936,-176;Float;False;World;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.FunctionNode;1188;-7472,1824;Inherit;False;MaxFromVector3;-1;;199;92f2539b674dd3042b132cfbdf18809e;0;1;1;FLOAT3;0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;237;-5808,-288;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SaturateNode;1918;-7312,1728;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1771;-782.7629,5614.481;Inherit;False;StaticScreenSpaceUV;-1;;200;1e9a29825d5b8df43882e5bd6744aaf5;0;1;7;FLOAT;1;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.SamplerNode;441;-3840.463,2031.383;Inherit;True;Property;_SpecularMaskTexture;Specular Mask Texture;17;2;[NoScaleOffset];[SingleLineTexture];Create;True;0;0;0;True;0;False;-1;None;0c021cea0cf2417459ce7fa844118e17;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.NormalizeNode;238;-5680,-288;Inherit;False;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;1416;-6272,2320;Inherit;False;1415;ShadowAtten;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;265;-5520,-288;Float;False;BNHalfDirection;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1274;-7037.281,1738.061;Inherit;False;Constant;_Float3;Float 3;101;0;Create;True;0;0;0;False;0;False;0.02;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1878;-7776,2560;Inherit;False;Property;_DiffuseWarpAffectHalftone;Diffuse Warp Affects Halftone;93;1;[Toggle];Create;False;0;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;254;-8256,4256;Inherit;False;265;BNHalfDirection;1;0;OBJECT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SamplerNode;361;-6656,1648;Inherit;True;Property;_LightRampTexture;Light Ramp Texture;10;2;[NoScaleOffset];[SingleLineTexture];Create;False;0;0;0;True;1;;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.RangedFloatNode;1876;-5680,2224;Inherit;False;Property;_UseDiffuseWarpAsOverlay;Impact Shadows;94;1;[Toggle];Create;False;0;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.LightColorNode;1618;-6080,1792;Inherit;False;0;3;COLOR;0;FLOAT3;1;FLOAT;2
Node;AmplifyShaderEditor.SaturateNode;1360;-5904,1984;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;1451;-5792,1856;Inherit;False;Property;_ShadowColorMy;Shadow Color My;81;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;1680;-5853.912,1735.709;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT3;0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;1622;-5804.497,1548.024;Inherit;True;Property;_LightRampTexture;Light Ramp Texture;12;2;[NoScaleOffset];[SingleLineTexture];Fetch;True;0;0;0;True;1;;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.SamplerNode;1651;4420.51,1616.544;Inherit;True;Property;_OcclusionMap;Occlusion Map;88;0;Create;False;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.LerpOp;1629;-5440,2016;Inherit;False;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.Compare;1875;-5328,2240;Inherit;False;0;4;0;FLOAT;0;False;1;FLOAT;1;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;1931;-5488,1808;Inherit;False;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;1186;-1652.068,4326.253;Inherit;False;MaxFromVector3;-1;;201;92f2539b674dd3042b132cfbdf18809e;0;1;1;FLOAT3;0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;1376;5049.063,1127.798;Inherit;False;Property;_SpecColor;Specular Value;2;0;Fetch;False;0;0;0;True;0;False;1,1,1,0;1,1,1,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.LerpOp;1628;-5120,2032;Inherit;False;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.LerpOp;1626;-5152,1632;Inherit;False;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.LerpOp;1617;-5136,1872;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SamplerNode;508;-1663.055,4511.406;Inherit;True;Property;_HalftoneTexture;Halftone Texture;49;2;[NoScaleOffset];[SingleLineTexture];Create;True;0;0;0;True;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.SamplerNode;362;4392.602,1430.464;Inherit;True;Property;_MainTex;Albedo Texture;9;0;Create;False;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.ColorNode;204;4959.695,1361.061;Inherit;False;Property;_Color;Color;6;0;Create;True;0;0;0;True;0;False;0.6792453,0.6792453,0.6792453,1;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.LightColorNode;406;-7088,3568;Inherit;False;0;3;COLOR;0;FLOAT3;1;FLOAT;2
...
Node;AmplifyShaderEditor.ColorNode;679;4449.447,2133.176;Inherit;False;Property;_EmissionColor;Emission Color;37;1;[HDR];Create;True;0;0;0;True;0;False;0,0,0,0;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.SamplerNode;682;4339.97,1938.008;Inherit;True;Property;_EmissionMap;Emission Map;39;3;[HDR];[NoScaleOffset];[SingleLineTexture];Create;True;0;0;0;True;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.GetLocalVarNode;903;-6016,3872;Inherit;False;902;SpecularMask;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;1217;195.3033,3989.512;Inherit;False;Property;_HalftoneColor;Halftone Color;53;0;Create;False;0;0;0;True;0;False;0,0,0,1;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;243;-5120,3552;Float;False;BNspecularFinalColor;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;1187;-522.6708,2888.304;Inherit;False;MaxFromVector3;-1;;202;92f2539b674dd3042b132cfbdf18809e;0;1;1;FLOAT3;0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;1645;4602.21,-135.7343;Inherit;False;Property;_RimShadowColor;Rim Shadow Color;87;0;Create;False;0;0;0;True;0;False;0,0.05551431,0.9622642,0;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.ColorNode;456;4385.484,-675.5858;Inherit;False;Property;_RimColor;Rim Color;24;1;[HDR];Create;True;0;0;0;True;0;False;1,1,1,0;1,1,1,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.ColorNode;1253;-2070.124,1585.938;Inherit;False;Property;_HatchingColor;Hatching Color;66;0;Create;False;0;0;0;True;0;False;0,0,0,1;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.ColorNode;44;36.07047,-600.1439;Inherit;False;Property;_OutlineColor;Outline Color;5;1;[HDR];Create;True;0;0;0;True;0;False;0,0,0,0;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.StickyNoteNode;1914;-6400,-144;Inherit;False;319;107;;;1,1,1,1;Turning OFF specular lightning for additional lights due to the 'range square' issue;0;0
Node;AmplifyShaderEditor.StaticSwitch;1024;-144,1008;Inherit;False;Property;_OverlayMode;Overlay Mode;78;0;Create;True;0;0;0;False;0;False;0;0;0;True;;KeywordEnum;3;None;Haftone;Hatching;Create;True;True;All;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.OutlineNode;1857;368,144;Inherit;False;2;True;None;0;0;Front;True;True;True;True;0;False;;3;0;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.StickyNoteNode;1932;-5440,1392;Inherit;False;319;107;;;1,1,1,1;Shadow color that is not black (0,0,0) will break shader that has additional light lightning on;0;0
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;1852;500,832;Float;False;True;-1;2;ToonProEditor;0;0;CustomLighting;Toon Pro;False;False;False;False;False;True;True;True;True;False;False;False;False;False;False;False;False;False;False;False;False;Back;0;False;;0;False;;False;0;False;;0;False;;False;0;Opaque;0.5;True;True;0;False;Opaque;;Geometry;All;12;all;True;True;True;True;0;False;;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;2;15;10;25;False;0.5;True;0;0;False;;0;False;;0;0;False;;0;False;;0;False;;0;False;;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;True;Relative;0;;-1;-1;-1;-1;0;False;0;0;False;;-1;0;False;;0;0;0;False;0.1;False;;0;False;;False;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;16;FLOAT4;0,0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
WireConnection;1629;0;1451;5
WireConnection;1629;1;1618;1
WireConnection;1629;2;1331;0
WireConnection;1875;0;1876;0
WireConnection;1875;2;1486;0
WireConnection;1875;3;1416;0
WireConnection;1931;0;1451;5
WireConnection;1931;1;1618;1
WireConnection;1931;2;1360;0
...
WireConnection;1628;0;1451;5
WireConnection;1628;1;1629;0
WireConnection;1628;2;1875;0
WireConnection;1626;0;1451;5
WireConnection;1626;1;1931;0
...
ASEEND*/
//CHKSM=50EC49FC7353BC31131379E15B1CBE1E62F0F5F3